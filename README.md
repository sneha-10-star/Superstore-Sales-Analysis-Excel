---
Superstore Sales Performance | Excel Portfolio
---
📌 Project Overview
...
Utilized Pivot Tables to structure the analysis layer and calculate metrics.

✔ Metric Calculation

Created custom views for Order Count and Average Sale Value to go beyond basic sum totals.
